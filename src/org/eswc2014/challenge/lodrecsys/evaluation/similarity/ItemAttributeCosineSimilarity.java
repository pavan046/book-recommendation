/**
 * ItemAttributeCosineSimilarity.java
 *
...
public class ItemAttributeCosineSimilarity extends ItemAttributeSimilarity {
    ...
    /**
     * Builds an empty ItemAttributeCosineSimilarity instance.
     */
    public ItemAttributeCosineSimilarity() {
    }
    ...
    public double similarityOf(Item item1, Item item2) throws Exception {
        ...
        Map<String, Double> vector1 = item1.getAttributes();
        Map<String, Double> vector2 = item2.getAttributes();
